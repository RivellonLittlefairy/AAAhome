    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        viewHolder.img.setOnClickListener {
            ...
            AAAhomeApplication.startActivity<DetailActivity> {
                it.putExtra("id",id)
                it.putExtra("lowPriceTime",wishList[position].nearlyLowestTimestamp)
                it.putExtra("lowPrice",wishList[position].priceLowest)
                it.putExtra("relaseDate",wishList[position].relaseDate)
            }
        }
