...
public final class FragmentDiscountBinding implements ViewBinding {
  ...
  private FragmentDiscountBinding(@NonNull ConstraintLayout rootView,
      @NonNull RecyclerView recyclerDiscount) {
    this.rootView = rootView;
    this.recyclerDiscount = recyclerDiscount;
  }
  ...
  public static FragmentDiscountBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.recycler_discount;
      RecyclerView recyclerDiscount = ViewBindings.findChildViewById(rootView, id);
      if (recyclerDiscount == null) {
        break missingId;
      }

      return new FragmentDiscountBinding((ConstraintLayout) rootView, recyclerDiscount);
    }
